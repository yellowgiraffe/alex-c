...
// Придумала ещё такой вариант, не уверена или можно в этом задании использовать массивы

// let dayOfWeek = +prompt("Какой сейчас день недели?", "");

// let arr = ["День 1, день недели Понедельник", "День 2, день недели Вторник", "День 3, день недели Среда", "День 4, день недели Четверг", "День 5, день недели Пятница", "День 6, день недели Суббота", "День 7, день недели Воскресенье"];
